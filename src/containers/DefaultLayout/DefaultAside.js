        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            ...
            <div className="message">
              ...
              <div className="text-truncate font-weight-bold">RELEASES</div>
              <small className="text-muted font-weight-bold">V 1.0.0  <i className="icon-calendar"></i>&nbsp; March - 2019
              </small>
              <p></p>              
              <small className="text-muted font-weight-bold">V 1.0.1  <i className="icon-calendar"></i>&nbsp; May - 2019
              </small>
              <p></p> 
              <small className="text-muted font-weight-bold">V 1.0.2  <i className="icon-calendar"></i>&nbsp; August - 2019
              </small>
              <p></p> 
            </div>
